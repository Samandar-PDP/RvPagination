...
import com.sdk.rvpagination.adapter.Paging3Adapter
import com.sdk.rvpagination.databinding.ActivityPaging3Binding
import com.sdk.rvpagination.viewmodel.PagingViewModel
import kotlinx.coroutines.flow.collectLatest

class Paging3Activity : AppCompatActivity() {
    private val binding by lazy { ActivityPaging3Binding.inflate(layoutInflater) }
    ...
    private fun initViews() {
        binding.rv.apply {
            ...
            addItemDecoration(DividerItemDecoration(this@Paging3Activity, LinearLayoutManager.VERTICAL))
        }
        setupVm()
    }
    private fun setupVm() {
