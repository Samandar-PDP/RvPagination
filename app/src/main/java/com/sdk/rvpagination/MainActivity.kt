...
import com.sdk.rvpagination.adapter.CustomPagingAdapter
import com.sdk.rvpagination.adapter.RvScrollingListener
import com.sdk.rvpagination.databinding.ActivityMainBinding
import com.sdk.rvpagination.model.Item
import com.sdk.rvpagination.network.RetroInstance
        ...
        RetroInstance.retroInstance().getUsers(currentPage).enqueue(object : Callback<Item> {
            override fun onResponse(call: Call<Item>, response: Response<Item>) {
                if (response.isSuccessful) {
                    ...
                    paginationAdapter.addUserList(response.body()?.data?.toMutableList() ?: mutableListOf())
